...
function About() {
  return (
    <section id="sobre" className="scroll-mt-24 py-12 md:py-16 px-4 sm:px-6 max-w-5xl mx-auto w-full">
      <motion.div
        initial="hidden"
        whileInView="visible"
      ...
      >
        <SectionHeading kicker="Quem somos" title="Mais Sobre Nós" align="left" />
        <motion.p
        ...
        >
          ...
          transformar ideias complexas em sistemas ágeis. Nosso foco principal
          é utilizar tecnologias modernas e arquiteturas escaláveis para
          entregar não apenas código, mas sim tempo e produtividade para os
          nossos clientes.
        </motion.p>
